...
class NestedDictionary:
    ...
    def extract_key_datatypes(self) -> set[str]:
        ...
        """
    def _convert_key_to_datatype(self, key: Any, datatype: Literal['int', 'str', 'float', 'None']) -> int | str | float | None:
        ...
        '''
    def _convert_variable_path_to_keys(self, variable_path: str | NDArray[Any] | tuple[Any, ...] | list[Any]) -> tuple[Any, ...]:
    ...
    def read_nested_value(self, variable_path: str | tuple[Any, ...] | list[Any] | NDArray[Any]) -> Any:
        ...
        """
    def write_nested_value(self, variable_path: str | tuple[Any, ...] | list[Any] | NDArray[Any], value: Any, *, modify_class_dictionary: bool = True, allow_terminal_overwrite: bool = True, allow_intermediate_overwrite: bool = False) -> NestedDictionary | None:
        ...
        """
    def delete_nested_value(self, variable_path: str | tuple[Any, ...] | list[Any] | NDArray[Any], *, modify_class_dictionary: bool = True, delete_empty_sections: bool = True, allow_missing: bool = False) -> NestedDictionary | None:
        ...
        Raises:
            KeyError: If any of the target keys are not found at the expected dictionary level, and missing keys are not
                allowed.
        """
    def find_nested_variable_path(self, target_key: str | int | float | None, search_mode: Literal['terminal_only', 'intermediate_only', 'all'] = 'terminal_only', *, return_raw: bool = False) -> tuple[tuple[Any, ...] | str, ...] | tuple[Any, ...] | str | None:
        ...
        """
    def convert_all_keys_to_datatype(self, datatype: Literal['str', 'int'], *, modify_class_dictionary: bool = True) -> NestedDictionary | None:
