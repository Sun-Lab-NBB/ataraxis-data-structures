...
class SharedMemoryArray:
    ...
    _array: Incomplete
    _is_connected: bool
    def __init__(self, name: str, shape: tuple[int, ...], datatype: np.dtype[Any], buffer: SharedMemory | None) -> None: ...
    ...
    def _optional_lock(self, with_lock: bool) -> Generator[Any, Any, None]:
        ...
        """
    def read_data(self, index: int | tuple[int, int], *, convert_output: bool = False, with_lock: bool = True) -> NDArray[Any] | list[Any] | np.dtype[Any] | int | float | bool | str | None:
        ...
        """
    def write_data(self, index: int | tuple[int, int], data: NDArray[Any] | list[Any] | tuple[Any] | np.dtype[Any] | int | float | bool | str | None, with_lock: bool = True) -> None:
